...
$sql = "SELECT `user_Fname`,`user_Lname`,`content`,`file_atch` FROM `tickets`  ";
$result = $db->query($sql);

$adminsql = "SELECT `ticket_id`, `user_Fname`, `user_Lname`, `content`, `send_time`, `file_atch`, `deleted` FROM `tickets` ";
